  ...
  data() {
    return {
      group_data: [
        {
          title:
            '2.1 ลงมติทั้งหมดเป็นผลบวกกับรัฐบาลสายอำนาจเก่า และทหาร ขณะมีอำนาจ',
          data: [
        ...
        {
          title:
            '2.3 ลงมติทั้งหมดเป็นผลบวกกับรัฐบาลสายอำนาจเก่า และทหาร ขณะมีอำนาจ และลงมติทั้งหมดเป็นผลลบกับรัฐบาลสายทักษิณ ชินวัตร ขณะมีอำนาจ',
          data: [
