  ...
  <div id="timeline" v-if="data.length" class="mt-3">
    ...
    <div class="flex items-center h-screen" id="intro">
      <div
        ...
        "
      >
        นอกจากการวินิจฉัยของศาลรัฐธรรมนูญ ผลลงมติรายบุคคลของตุลาการรัฐธรรมนูญ
        ก็เป็นส่วนหนึ่งในการสร้างผลลัพธ์สำคัญทางการเมืองเช่นกัน
        โดยคณะตุลาการแต่ละชุดก็มีที่มาแตกต่างกันออกไป
      </div>
    </div>
  </div>
</template>
